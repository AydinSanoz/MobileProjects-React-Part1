...
import { SafeAreaView, Text, View, KeyboardAvoidingView, FlatList, Platform } from 'react-native';

import { main } from './styles';
import { TodoInput, TodoCard } from './components/components';
...
const Main = () => {
    ...
    return (
        <SafeAreaView style={main.container}>
            <KeyboardAvoidingView style={main.container} behavior={Platform.OS=='ios'? "padding":null} >
