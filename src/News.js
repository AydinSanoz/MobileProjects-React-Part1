...
import { SafeAreaView, View, Text, ScrollView, Image, FlatList, Dimensions,StyleSheet, ImageBackground} from 'react-native';
                        ...
                        banner_data.map(banner_item => {
                            return (
                                <View>
                                    ...
                                    <ImageBackground style={styles.bannerImage} source={{ uri: banner_item.imageUrl }}>
                                        <View style = {{position : 'absolute',justifyContent:'flex-end',top:0,bottom:0,right:0,left:0}}>
